...
<article <?php hybrid_attr( 'post' ); ?>>
	...
	<header class="entry-header">
		...
		<div class="entry-byline">
			<span class="image-sizes"><?php printf( esc_html__( 'Sizes: %s', 'creativepress' ), hybrid_get_image_size_links() ); ?></span>
		</div><!-- .entry-byline -->
...
<div class="attachment-meta">
	...
	<div class="media-info image-info">
		...
		<h3 class="attachment-meta-title"><?php esc_html_e( 'Image Info', 'creativepress' ); ?></h3>
	...
	<?php if ( ! empty( $gallery ) ) : // Check if the gallery is not empty. ?>
		...
		<div class="image-gallery">
			<h3 class="attachment-meta-title"><?php esc_html_e( 'Gallery', 'creativepress' ); ?></h3>
			<?php echo $gallery; ?>
		</div>
